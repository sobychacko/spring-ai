...
public final class SpringAiAnthropicHttpClient implements HttpClient {
	...
	private SpringAiAnthropicHttpClient(OkHttpClient okHttpClient, Backend backend) {
	...
	public static final class Builder {
		...
		public SpringAiAnthropicHttpClient build() {
			...
			ExecutorService dispatcherBase = (this.dispatcherExecutorService != null) ? this.dispatcherExecutorService
			...
			return new SpringAiAnthropicHttpClient(okClient, resolvedBackend);
		}
